...
## **Technologies Used**
### **Frontend (UI)**
- **WinForms** - Windows-based UI development
- **DevExpress** - Enhanced UI components

### **Backend**
- **C# (.NET Framework)** - Core application logic
- **Entity Framework (EF)** - ORM for database interaction

### **Database**
- **MS-SQL Server** - Relational database for employee data storage
...
## **Installation**
### **Prerequisites**
- **.NET Framework SDK** installed ([Download Here](https://dotnet.microsoft.com/))
...
```sh
git clone https://github.com/dgkans/PersonnelTrackingApp.git
